...
This directory is part of `flow-skill` and is intended to be self-contained.

When the skill folder is copied out on its own, these Markdown files remain available as the local reference set for specialized draw.io libraries.

Use these files before generating AWS, Azure, GCP, Kubernetes, BPMN, Cisco, floorplan, infographic, or other library-backed diagrams.
